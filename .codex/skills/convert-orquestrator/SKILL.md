---
name: convert-orquestrator
description: Use when converting the full .claude source tree into the generated formats used by Cursor and Codex in this repository.
---
